        ...
        <div className="max-w-[1280px] flex items-center justify-center flex-col lg:flex-row-reverse gap-x-20">
          ...
          <div>
            ...
            <motion.p
              ...
              className="py-6  "
            >
              I specialize in designing and developing innovative solutions
              using Flutter and Dart. Explore my journey, projects, and skills
              as I work toward building the future of mobile applications.
            </motion.p>
          </div>
        </div>
      </div>
